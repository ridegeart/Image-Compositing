...
3. draw bboxes
    - `tools/draw_box.py` 
    - parameter settings：
        1. `LABEL_FOLDER` ： bboxes label folder
        2. `RAW_IMAGE_FOLDER` ： raw picture folder
        3. `OUTPUT_IMAGE_FOLDER` ： output images folder
        4. `IMAGE_NAME_LIST_PATH` ： image name list
