...
def draw_box_on_image(image_name, classes, colors, LABEL_FOLDER, RAW_IMAGE_FOLDER, OUTPUT_IMAGE_FOLDER):
    ...
    if os.path.exists(OUTPUT_IMAGE_FOLDER) is False:
...
if __name__ == '__main__':           
    ...
    LABEL_FOLDER = './mmdet_api/mmdetection/runs/exp5/labels_croped_fusion/'  # Put the label files in this folder. 
    RAW_IMAGE_FOLDER = './datasets/fusion_image/val/images_bg'  # Put the original images without boxes in this folder. 
    OUTPUT_IMAGE_FOLDER = './mmdet_api/mmdetection/runs/exp5/images/'  # The output images would be saved to this folder
    IMAGE_NAME_LIST_PATH = './datasets/fusion_image/val/val.txt'  # The file name of images will be saved into this text file.
    ...
    box_num = draw_box_on_image(
      '20240420_bg', classes, colors, LABEL_FOLDER, RAW_IMAGE_FOLDER, OUTPUT_IMAGE_FOLDER)  
    box_total += box_num
    image_total += 1
